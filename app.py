...
def db_seed():
    ...
    test_user = User(first_name='John', last_name='Doe', email='jd@test.com', password='P@ssw0rd')
...
def add_planet():
    ...
    if test:
        ...
        db.session.commit()
        return jsonify(message='Planet added a planet successfully'), 201
...
def update_planet():
    ...
    if planet:
        ...
        return jsonify(message='The planet does not exist in DB'), 404
...
def remove_planet(planet_id: int):
    ...
    if planet:
        ...
        db.session.commit()
        return jsonify(message='You have successfully deleted the planet'), 200
    else:
